...
public class Board {
    ...
    /**
     * Initializes a board with the given parameters
     * @param customHeight = desired height of the board
     * @param customWidth = desired width of the board
     */
     ...
     * Initializes a board with the given parameters
     * @param customHeight = desired height of the board
     * @param customWidth = desired height of the board
     * @param diagonal = whether the rule is enabled
     * @param horizontal = whether the rule is enabled
     * @param vertical = whether the rule is enabled
     */
    public Board(int customHeight, int customWidth, boolean diagonal, boolean horizontal, boolean vertical) {
        height = customHeight;
        width = customWidth;
        map = new Cell[height+2][width+2];
     ...
     * @param customHeight = desired height of the board
     * @param customWidth = desired height of the board
     * @param customMap = desired map of Cells
     */
    ...
    public char[][] getBoard(){
        char[][] mapToPrint = new char[height][width];
        for (int i = 0; i < height + 2; i++) {
            for (int j = 0; j < width + 2; j++) {
                if(i != 0 && j != 0) {
                    if (map[i][j] == Cell.EMPTY) {
                        mapToPrint[i - 1][j - 1] = '0';
                    }
                    if (map[i][j] == Cell.BLACK) {
                        mapToPrint[i - 1][j - 1] = '1';
                    }
                    if (map[i][j] == Cell.WHITE) {
                        mapToPrint[i - 1][j - 1] = '2';
                    }
                }
            }
        }
